proc PeakResponse {period Ry} {
	...
	set e3p [expr (4+1.06/0.3)*$e1p];set s3p 1e-10;set e3n -$e3p;set s3n -$s3p;set pinchX 1;set pinchY 1; set damage1 0;set damage2 0;set beta 0;
